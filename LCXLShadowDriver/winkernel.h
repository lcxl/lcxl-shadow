...
#pragma once
#include <ntifs.h>
#include <ntimage.h>//PE文件有关的头文件

#include <ntdddisk.h>//磁盘相关的控制命令
#include <ntddvol.h>//卷相关的控制命令
#include <ntddstor.h>//磁盘存储有关的控制命令
#include <mountdev.h>
...
NTSYSAPI NTSTATUS NTAPI ZwSetSystemTime (
 ...
 __inline NTSTATUS LLCompleteRequest(IN NTSTATUS status, IN PIRP Irp, IN ULONG_PTR Information)
{
...
__inline NTSTATUS LLSendToNextDriver(IN PDEVICE_OBJECT TgtDevObj, IN PIRP Irp)
{
	//跳过当前的irp stack
